package xyz.waiphyoag.padc_3_f_wpa_popular_movies.activities.activities.network;
...
import xyz.waiphyoag.padc_3_f_wpa_popular_movies.activities.activities.network.responses.GetMoviesResponse;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Log.d(PopularMovieApp.LOG_TAG,"responseString :"+responseString);

                    Gson gson=new Gson();
                    GetMoviesResponse getMoviesResponse=gson.fromJson(responseString, GetMoviesResponse.class);
                    Log.d(PopularMovieApp.LOG_TAG,"getMoviesResponse movies size :" + getMoviesResponse.getMovies().size());
                    LoadedMovieEvent event=new LoadedMovieEvent(getMoviesResponse.getMovies());
                    EventBus.getDefault().post(event);

                } catch (Exception e) {
                    Log.d(PopularMovieApp.LOG_TAG,e.getMessage());
                } finally {
